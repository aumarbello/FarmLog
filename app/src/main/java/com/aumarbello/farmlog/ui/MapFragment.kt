...
class MapFragment : Fragment(R.layout.fragment_map) {
    ...
    private val viewModel by navGraphViewModels<EntrySharedViewModel>(R.id.new_entry) { factory }
    private val locationReq = 91
    ...
    private fun confirmLocation(location: LatLng, mode: String) {
        ...
        snackbar.setAction(R.string.action_confirm) {
            val farmLocation = FarmLocation(location.latitude, location.longitude)
